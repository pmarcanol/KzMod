...
{
    [EditorGroup("KzMod")]
    internal class BoxingGun : DartGun
    {

        public SpriteMap sprite;
        public BoxingGun(float xval, float yval) : base(xval, yval)
        {
        ...
        public override void OnPressAction()
        {
            if (this.ammo > 0)
            {
                ...
                else
                {
                    ...
                    Dart dart = new BoxingAmmo(vec2.x, vec2.y, this.owner as Duck, -radians);
